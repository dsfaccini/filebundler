...
│   │   └── 📄 token-ranking-tab.md (530 tokens)
│   ├── 📄 .gitignore (4 tokens)
│   ├── 📄 ignore-patterns.txt (228 tokens)
│   ├── 📄 project-structure.md (1872 tokens)
│   ├── 📄 selections.json (16 tokens)
│   └── 📄 settings.json (69 tokens)
├── 📁 .github/ (435 tokens)
...
│   ├── 📄 FileBundlerApp.py (1240 tokens)
│   ├── 📄 main.py (1213 tokens)
│   ├── 📄 mcp_server.py (587 tokens)
│   └── 📄 state.py (84 tokens)
├── 📁 memory-bank/ (112 tokens)
│   ├── 📄 global-instructions.md (112 tokens)
