...
│   ├── 📄 .gitignore (3 tokens)
│   ├── 📄 project-structure.md (1599 tokens)
...
├── 📁 filebundler/ (21523 tokens)
│   ├── 📁 features/ (1082 tokens)
│   │   └── 📁 tasks/ (1082 tokens)
│   │       ├── 📁 templates/ (958 tokens)
│   │       │   ├── 📄 example-task.md (297 tokens)
│   │       │   └── 📄 task-file-management.md (661 tokens)
