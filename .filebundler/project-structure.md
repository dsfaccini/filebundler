...
│   ├── 📄 .gitignore (4 tokens)
│   ├── 📄 ignore-patterns.txt (226 tokens)
│   ├── 📄 project-structure.md (2010 tokens)
...
├── 📁 dist/ (54 tokens)
│   ├── 📄 .gitignore (1 tokens)
│   ├── 📄 filebundler-0.9.19-py3-none-any.whl (29 tokens)
│   └── 📄 filebundler-0.9.19.tar.gz (24 tokens)
├── 📁 docs/ (7056 tokens)
│   ├── 📄 ci-cd.md (152 tokens)
