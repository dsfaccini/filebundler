1. [QOL] switch normal logging for logfire where it can help track blockages
...
3. [ROADMAP] create a new tab after "Manage Bundles" called "Auto-Bundle"
...
4. [TEST] we haven't written any test
5. [PACKAGE] package as a library so people can install it and run it
